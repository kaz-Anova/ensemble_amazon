...
Uses counts as features and 3way interactions and xgboost
...
def main():
    ...
    model=xg.XGBoostClassifier(num_round=1000 ,nthread=25,  eta=0.012, gamma=0.1,max_depth=30, min_child_weight=0.1, subsample=0.9, 
